# Market Research Agent using direct LLM calls and Tavily
...
def run_market_agent(idea: str):
    ...
    try:
        ...
        prompt = f"""
        You are a senior market research analyst with 12+ years of experience at top consulting firms. Analyze the market opportunity for: "{idea}"
        
        Market research data available: {market_data}
